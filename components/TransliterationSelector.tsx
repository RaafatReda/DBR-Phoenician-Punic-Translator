...
import { TransliterationMode } from '../types';
...
const TransliterationSelector: React.FC<TransliterationSelectorProps> = ({ currentMode, onModeChange, isDisabled, t }) => {
  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      <button
        ...
        aria-live="polite"
        aria-label={`Change transliteration mode. Current mode is ${currentMode}. Click to switch to ${nextMode}.`}
        style={{ minWidth: '90px', textAlign: 'center' }}
      >
        {t(currentMode.toLowerCase())}
      </button>
    </div>
  );
};
