...
export const zayin: GlossaryEntry[] = [
  ...
  { phoenician: '𐤆𐤁𐤇', latin: 'ZBḤ', meaning: { en: 'Sacrificial priest', fr: 'Prêtre sacrificiel', ar: 'كاهن ذبيحة' }, grammar: { pos: 'Noun', gender: 'm' } },
  { phoenician: '𐤆𐤁𐤇 𐤉𐤌𐤌', latin: 'ZBḤ YMM', meaning: { en: 'Periodic sacrifice', fr: 'Sacrifice périodique', ar: 'ذبيحة دورية' }, grammar: { pos: 'Noun', notes: 'Expression' } },
  { phoenician: '𐤆𐤁𐤇 𐤔𐤌𐤔', latin: 'ZBḤ ŠMŠ', meaning: { en: 'Zebaḥ Šemeš: A month of the Phoenician calendar', fr: 'Zebaḥ Šemeš: Un mois du calendrier phénicien', ar: 'ذبح شمس: شهر من التقويم الفينيقي' }, grammar: { pos: 'Noun' } },
  { phoenician: '𐤆𐤁𐤇 𐤔𐤔𐤌', latin: 'ZBḤ ŠŠM', meaning: { en: 'Zebaḥ ŠŠM: A month of the Phoenician calendar', fr: 'Zebaḥ ŠŠM: Un mois du calendrier phénicien', ar: 'ذبح ششم: شهر من التقويم الفينيقي' }, grammar: { pos: 'Noun' } },
  ...
  { phoenician: '𐤆𐤁𐤋', latin: 'ZBL', meaning: { en: 'Zebel (“The Prince”)', fr: 'Zebel (“Le Prince”)', ar: 'زبل (“الأمير”)' }, grammar: { pos: 'Noun', gender: 'm' }, category: 'theonym' },
  { phoenician: '𐤆𐤁𐤓', latin: 'ZBR', meaning: { en: 'Pitcher', fr: 'Cruche', ar: 'إبريق' }, grammar: { pos: 'Noun', gender: 'm' } },
  ...
  { phoenician: '𐤆𐤊𐤓', latin: 'ZKR', meaning: { en: 'Remember, keep in mind', fr: 'Se souvenir, garder à l\'esprit', ar: 'تذكر، ضع في اعتبارك' }, grammar: { pos: 'Verb' } },
  ...
  { phoenician: '𐤆𐤌𐤓', latin: 'ZMR', meaning: { en: 'Zimyra, city in Phoenicia; present-day Zimrīn', fr: 'Zimyra, cité de Phénicie; Zimrīn actuel', ar: 'زيميرا، مدينة في فينيقيا؛ زمرين الحالية' }, grammar: { pos: 'Noun' }, category: 'location' },
  { phoenician: '𐤆𐤍', latin: 'zn', meaning: { en: 'Kind, sort', fr: 'Sorte, genre', ar: 'نوع، صنف' }, grammar: { pos: 'Noun', gender: 'm', number: 's' } },
  { phoenician: '𐤆𐤍', latin: 'ZN', meaning: { en: 'This', fr: 'Ceci', ar: 'هذا' }, grammar: { pos: 'Pronoun', notes: 'Peculiar to Byblian Phoenician.' } },
  { phoenician: '𐤆𐤍', latin: 'ZN', meaning: { en: 'This there, that, yonder', fr: 'Celui-là, cela, là-bas', ar: 'ذلك، ذاك' }, grammar: { pos: 'Pronoun' } },
  ...
  { phoenician: '𐤆𐤒𐤍', latin: 'ZQN', meaning: { en: 'Beard', fr: 'Barbe', ar: 'لحية' }, grammar: { pos: 'Noun', gender: 'm' } },
  ...
  { phoenician: '𐤆𐤓', latin: 'ZR', meaning: { en: 'A monetary weight or value', fr: 'Un poids ou une valeur monétaire', ar: 'وزن أو قيمة نقدية' }, grammar: { pos: 'Noun', gender: 'm' } },
  { phoenician: '𐤆𐤓', latin: 'ZR', meaning: { en: 'Another, different', fr: 'Autre, différent', ar: 'آخر، مختلف' }, grammar: { pos: 'Adjective' } },
  ...
  { phoenician: '𐤆𐤕', latin: 'ZT', meaning: { en: 'Olive(s)', fr: 'Olive(s)', ar: 'زيتون' }, grammar: { pos: 'Noun', gender: 'm' } },
  { phoenician: '𐤆𐤉𐤁', latin: 'ZYB', meaning: { en: 'Zib, name of a month', fr: 'Zib, nom d\'un mois', ar: 'زيب، اسم شهر' }, grammar: { pos: 'Noun', gender: 'm' } },
