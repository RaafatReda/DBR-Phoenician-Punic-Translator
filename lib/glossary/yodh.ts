...
export const yodh: GlossaryEntry[] = [
  ...
  { phoenician: '𐤉𐤅𐤍𐤉', latin: 'ywnī', meaning: { en: 'Greek / Ionian (singular).', fr: 'Grec / Ionien (singulier).', ar: 'يوناني / أيوني (مفرد).' }, grammar: { pos: 'Noun' }, category: 'personal_name' },
  { phoenician: '𐤉𐤅𐤍𐤌', latin: 'ywnm', meaning: { en: 'Greeks / Ionians (plural).', fr: 'Grecs / Ioniens (pluriel).', ar: 'يونانيون / أيونيون (جمع).' }, grammar: { pos: 'Noun', gender: 'm', number: 'p' }, category: 'personal_name' },
  ...
  { phoenician: '𐤉𐤌', latin: 'ym', meaning: { en: 'Day', fr: 'Jour', ar: 'يوم' }, grammar: { pos: 'Noun', gender: 'm', number: 's' } },
  { phoenician: '𐤉𐤍𐤒', latin: 'ynq', meaning: { en: 'To suckle', fr: 'Téter', ar: 'يرضع' }, grammar: { pos: 'Verb', stem: 'G-stem' } },
  { phoenician: '𐤉𐤍𐤕', latin: 'yūn', meaning: { en: 'Dove', fr: 'Colombe', ar: 'حمامة' }, grammar: { pos: 'Noun', gender: 'f', number: 's', notes: 'Latin also `yūnot`.' } },
  ...
  { phoenician: '𐤉𐤓𐤒', latin: 'yrq', meaning: { en: 'Green. Reconstructed term for “green.”', fr: 'Vert. Terme reconstruit pour "vert".', ar: 'أخضر. مصطلح أعيد بناؤه لـ "الأخضر".' }, grammar: { pos: 'Adjective', notes: 'Also means vegetable.' } },
