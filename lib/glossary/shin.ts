...
export const shin: GlossaryEntry[] = [
  ...
  { phoenician: '𐤔𐤊𐤋𐤉𐤌', latin: 'šklym', meaning: { en: 'Siculans / Sicilians (plural).', fr: 'Sicules / Siciliens (pluriel).', ar: 'الصقليون (جمع).' }, grammar: { pos: 'Noun', gender: 'm', number: 'p' }, category: 'personal_name' },
  { phoenician: '𐤔𐤊𐤓', latin: 'škr', meaning: { en: 'To be drunk', fr: 'Être ivre', ar: 'يسكر' }, grammar: { pos: 'Verb', stem: 'G-stem' } },
  { phoenician: '𐤔𐤊𐤔𐤉', latin: 'škšī', meaning: { en: 'Sexitan, an inhabitant of Sexi (Almuñécar).', fr: 'Sexitan, un habitant de Sexi (Almuñécar).', ar: 'سيكسيتاني، من سكان سيكسي (ألمونيكار).' }, grammar: { pos: 'Noun' }, category: 'personal_name' },
  ...
  { phoenician: '𐤔𐤋𐤌', latin: 'šlm', meaning: { en: 'Salamis (Cyprus).', fr: 'Salamine (Chypre).', ar: 'سلاميس (قبرص).' }, grammar: { pos: 'Noun' }, category: 'location' },
  ...
  { phoenician: '𐤔𐤌𐤍𐤄', latin: 'šmnh', meaning: { en: 'Eight', fr: 'Huit', ar: 'ثمانية' }, grammar: { pos: 'Numeral' } },
  { phoenician: '𐤔𐤌𐤕', latin: 'šmt', meaning: { en: 'Carnelian (Reddish-purple). Refers to the semi-precious stone carnelian, typically reddish or purplish.', fr: 'Cornaline (Rougeâtre-violet). Fait référence à la pierre semi-précieuse cornaline, généralement rougeâtre ou violacée.', ar: 'عقيق (أحمر-أرجواني). يشير إلى حجر العقيق شبه الكريم، وهو عادة ما يكون محمراً أو أرجوانياً.' }, grammar: { pos: 'Noun', gender: 'f', number: 's' } },
  ...
  { phoenician: '𐤔𐤍𐤉', latin: 'šny', meaning: { en: 'Crimson Red. Term for crimson or scarlet red.', fr: 'Rouge cramoisi. Terme pour le rouge cramoisi ou écarlate.', ar: 'أحمر قرمزي. مصطلح للون القرمزي أو الأحمر الفاقع.' }, grammar: { pos: 'Noun', gender: 'm', number: 's' } },
  ...
  { phoenician: '𐤔𐤓𐤃𐤍𐤉', latin: 'šrdnī', meaning: { en: 'Sardinian, an inhabitant of Sardinia.', fr: 'Sarde, un habitant de la Sardaigne.', ar: 'سرديني، من سكان سردينيا.' }, grammar: { pos: 'Noun' }, category: 'personal_name' },
