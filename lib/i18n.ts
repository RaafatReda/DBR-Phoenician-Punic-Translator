...
export const translations: Record<UILang, Record<string, string>> = {
  en: {
    ...
    fontSizeLarge: 'Large',
    textScannerTitle: 'Scan text from camera',
    textScannerClose: 'Close Scanner',
    capture: 'Capture',
    switchCamera: 'Switch Camera',
    retakePhoto: 'Retake',
    usePhoto: 'Use Photo',
    noTextFoundInImage: 'No recognizable text was found in the image.',
  ...
  fr: {
    ...
    textScannerTitle: 'Scanner du texte depuis la caméra',
    textScannerClose: 'Fermer le Scanner',
    capture: 'Capturer',
    switchCamera: 'Changer de Caméra',
    retakePhoto: 'Reprendre',
    usePhoto: 'Utiliser la Photo',
    noTextFoundInImage: 'Aucun texte reconnaissable n\'a été trouvé dans l\'image.',
  ...
  ar: {
    ...
    fontSizeLarge: 'كبير',
    textScannerTitle: 'مسح النص من الكاميرا',
    textScannerClose: 'إغلاق الماسح',
    capture: 'التقاط',
    switchCamera: 'تبديل الكاميرا',
    retakePhoto: 'إعادة الالتقاط',
    usePhoto: 'استخدام الصورة',
    noTextFoundInImage: 'لم يتم العثور على نص يمكن التعرف عليه في الصورة.',
